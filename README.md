...
The data used for the publication is in the tsv data. The R code should produce the same figures as in the manuscript, and can be used for any ecotaxa export output. 

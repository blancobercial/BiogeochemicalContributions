...
ecotaxa_export <- 
  read.delim("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Supp_data_QC_AEM.tsv", header=TRUE)
...
write.csv(sub3,file=paste ##MANUALLY SET THE PATH. cREATE FOLDER IN ADVANCE
          ("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/",Tow,"_Classified_FOR_R.csv", sep=""),
          row.names=F)
...
library(readxl)
  ...
  # All_Tows_for_R<-sub4
  # OR
All_Tows_for_R <- read.csv("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/M13_t17_Classified_FOR_R.csv", header=TRUE) 
  # OR
...
thewholeshabang<-function(df, na.rm=TRUE){
  ...
  write.csv(summary,file=paste("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/",Tow,"_bins.csv", sep=""), row.names = F)
  ...
  write.csv(netsum,file=paste("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/",Tow,"_nets.csv", sep=""),row.names=F)
  ...
  ggplot(data=(summary), aes(x=net, y=BM_m2, fill="#D72000", alpha=fraction))+geom_bar(stat="identity")+
    ...
    guides(fill=FALSE)+
    ylim(0,500)
  ggsave(filename=paste(Tow,"BM_bynet.png", sep="_"),path=paste("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/", sep=""), width=6, height=6, units="in", dpi=300)
  ...
  ggplot(data=(summary), aes(x=net, y=oxy_m2, fill="#FFAD0A", alpha=fraction))+geom_bar(stat="identity")+
    ...
    guides(fill=FALSE)+
    ylim(0,5000)
  ggsave(filename=paste(Tow,"AOU_bynet.png", sep="_"),path=paste("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/", sep=""), width=6, height=6, units="in", dpi=300)
...
WF<-read.csv("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/M4_bins.csv")
str(WF)
...
WFplot
  # set your path
ggsave(WFplot,filename=paste(Title,"Waterfall.png", sep=" "), path=paste("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/", sep=""), width=6, height=5, units="in" )
...
capture.output(fits,file=paste("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/WF_",Title,"_reg_stats.txt"))
...
day_bin<-read.csv("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/M4_bins.csv")
#SET YOUR PATH HERE, PICKING THE NIGHT OF A PAIR
night_bin<-read.csv("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/M3_bins.csv")
...
write.csv(DN2,file=paste("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/",I,"_DayNightNETS.csv",sep=""),row.names=FALSE)
...
ggsave(p1,filename=paste(I,"DNPlot.png", sep="_"),path="C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/", width=8, height=7, units="in", dpi=300)
...
#SET YOUR PATH HERE, PICKING THE DAY OF A PAIR
day2<-read.csv("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/M13_t17_bins.csv")
#SET YOUR PATH HERE, PICKING THE NIGHT OF A PAIR
night2<-read.csv("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/M12_t17_bins.csv")
...
write.csv(dn.hm4,file=paste("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/",J,"_DayNight.csv",sep=""),row.names=FALSE)
...
BV.heatmap
ggsave(BV.heatmap,filename=paste(J,"BV_Shift.png", sep="_"),path=paste("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/",sep=""), width=8, height=5, units="in", dpi=300)
...
CO2.heatmap<-ggplot(data=dn.hm4, mapping=aes(x=bin, y=net, fill=CO2, color=""))+
  ...
  guides(color=guide_legend(order=2, override.aes=list(fill="gray45")))
CO2.heatmap
ggsave(CO2.heatmap,filename=paste(J,"CO2_Shift.png", sep="_"),path=paste("C:/Users/amy.maas/Dropbox (BIOS)/ZoopGroup_LAB/BIOSSCOPE_data analyses/Histogram_paper/Output/",sep=""), width=8, height=5, units="in", dpi=300)
